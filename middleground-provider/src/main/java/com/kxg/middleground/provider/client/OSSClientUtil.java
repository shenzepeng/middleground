package com.kxg.middleground.provider.client;

import com.aliyun.oss.OSSClient;
import com.aliyun.oss.model.ObjectMetadata;
import com.aliyun.oss.model.PutObjectResult;

import com.kxg.middleground.provider.model.FileType;
...
public class OSSClientUtil {
    ...
    private String accessKeySecret = "Gk9syIX5efcIHaguqs2FpNFmZn8nbj";
    //空间
    ...
    public String uploadImg2Oss(MultipartFile file, FileType fileType) {
        ...
        if (file.getOriginalFilename() == null) {
             ...
             substring=fileType.getFileType();
        }
